...
const CONFIG_SECTIONS = [
  {
    ...
    fields: [
      ...
      { key: "registration_enabled", label: "Registro manual (email y contraseña)", type: "boolean", hint: "Controla si nuevas personas pueden crear cuentas con email y contraseña. Al desactivarlo, la página de registro muestra el mensaje configurado abajo. Los usuarios existentes pueden seguir iniciando sesión normalmente.", messageField: "registration_disabled_message", messageLabel: "Mensaje en página de registro (visible para el usuario)" },
      { key: "google_registration_enabled", label: "Registro con Google", type: "boolean", hint: "Controla si nuevas personas pueden registrarse usando su cuenta de Google. Al desactivarlo, si alguien intenta registrarse con Google será rechazado con el mensaje configurado abajo. Los usuarios que ya se registraron con Google pueden seguir iniciando sesión.", messageField: "google_registration_disabled_message", messageLabel: "Mensaje cuando Google está deshabilitado (visible para el usuario)" },
